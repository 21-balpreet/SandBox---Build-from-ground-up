  ...
  return (
    <div className="flex-grow flex items-center justify-center px-4 bg-[#020617] py-16">
      ...
      <motion.div
        ...
        className="w-full max-w-md bg-[#0f172a] border border-slate-850 p-6 sm:p-8 rounded-2xl shadow-xl shadow-black/40 z-10"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-xs sm:text-sm mt-1">Unlock AI-powered tracking and placement insights</p>
        </div>
